...
const storage = multer.diskStorage({
    ...
    filename: (req, file, cb) => {
        ...
        console.log(`[BACKEND-UPLOAD] Storing file: ${originalName} as ${fileName}`); // NEW LOG
        cb(null, fileName);
    }
});
...
app.get('/api/files/info/:fileName', (req, res) => {
    ...
    console.log(`[BACKEND-INFO] Attempting to find file at path: ${filePath}`); // NEW LOG

    if (!fs.existsSync(filePath)) {
        console.log(`[BACKEND-INFO] File not found for info request at: ${filePath}`); // NEW LOG
    ...
    try {
        ...
        console.error(`[BACKEND-INFO] Error getting file stats for ${serverFileName}:`, error); // NEW LOG
...
app.get('/api/files/download/:fileName', (req, res) => {
    ...
    console.log(`[BACKEND-DOWNLOAD] Attempting to serve file from path: ${filePath}`); // NEW LOG
    ...
    if (fs.existsSync(filePath)) {
        ...
        console.log(`[BACKEND-DOWNLOAD] File not found for download at path: ${filePath}`); // NEW LOG
